...
public class CustomPostProcessing : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        postProcessingMaterial.SetFloat("_cloudsLayerCentreConcetaration", cloudsLayerCentreConcetaration);
        postProcessingMaterial.SetFloat("_cloudsHight", cloudsHight);
        postProcessingMaterial.SetFloat("_cloudsLayerWith", cloudsLayerWith);
